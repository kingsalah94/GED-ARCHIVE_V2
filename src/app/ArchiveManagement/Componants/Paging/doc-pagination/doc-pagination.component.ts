...
@Component({
  ...
  styleUrls: ['./doc-pagination.component.css']
})
export class DocPaginationComponent implements OnChanges{
  ...
  setPage(page: number) {
    ...
    this.pager = this.paginate(this.document.length, page, this.pageSize, this.maxPages);

    // get new page of items from items array
    const pageOfDocuments = this.document.slice(this.pager.startIndex, this.pager.endIndex + 1);

    // call change page function in parent component
    this.changePage.emit(pageOfDocuments);
  }
